      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2"><Label htmlFor="credit-limit">限度額（円）</Label><Input id="credit-limit" type="number" value={creditLimit} onChange={(e) => setCreditLimit(e.target.value)} placeholder="金額を入力" min="0" /></div>
            <div className="space-y-2"><Label htmlFor="current-balance">現在の利用残高（円）</Label><Input id="current-balance" type="number" value={currentBalance} onChange={(e) => setCurrentBalance(e.target.value)} placeholder="金額を入力" min="0" /></div>
